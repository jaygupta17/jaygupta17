<p>
  <img src="./assets/banner.png" alt="Jay Gupta. AI engineer, agents, evals, llm infra." width="100%">
</p>
...
- `prev` prepairo: GRE AI tutor and a daily ETL pipeline (3× app downloads, 60% DAU growth)
...
- `sketchpen` script in, animated whiteboard explainer out. custom renderer, word-level voice sync. [sketchpen.app](https://sketchpen.app)
